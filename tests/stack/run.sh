...
ONLINE_TESTS="radicle-archive.sh radicle-archive-multipeer.sh radicle-archive-rewrite.sh radicle-restore.sh radicle-reseed.sh vendor-free-restore.sh publication-durability.sh batch-mutability.sh"
