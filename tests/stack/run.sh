...
OFFLINE_TESTS="fixture-shape.sh ancestry-diagnosis.sh"
# Tests that need SWARM_API, a batch and a key.
ONLINE_TESTS="radicle-archive.sh radicle-archive-multipeer.sh radicle-archive-rewrite.sh radicle-cobs.sh radicle-restore.sh radicle-reseed.sh vendor-free-restore.sh publication-durability.sh batch-mutability.sh"
